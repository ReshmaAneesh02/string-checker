...
<body>
    ...
    <br>
        ...
        <form action="<?php echo e(url('/check-strings')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <table>
                <tr>
                    <td>
            ...
            <div class="results">
                ...
                <ul>
                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>String <?php echo e($index + 1); ?>: <?php echo e($result); ?></li>
...
<?php /**PATH D:\master\resources\views/master_string.blade.php ENDPATH**/ ?>